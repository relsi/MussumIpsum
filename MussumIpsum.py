...
class MussumIpsumCommand(sublime_plugin.TextCommand):
	def run(self, edit, quantis=1):
		...
		for martelis in cachassis:
			...
			self.view.insert(biritis, martelis.begin(), textis)
